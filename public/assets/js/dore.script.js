        ...
        var myChart = new Chart(conversionChart, {
          ...
          data: {
            ...
            datasets: [
              {
                label: "Players",
                data: [65, 60, 68, 54, 63, 60, 63, 65, 60, 68, 54, 63],
                borderColor: "#FF634D",
                pointBackgroundColor: foregroundColor,
                pointBorderColor: "#FF634D",
                pointHoverBackgroundColor: "#FF634D",
                pointHoverBorderColor: foregroundColor,
                pointRadius: 0,
                pointBorderWidth: 1,
                pointHoverRadius: 5,
              ...
              {
                label: "Members",
                data: [55, 52, 58, 52, 53, 55, 52, 58, 50, 54, 52, 53],
                borderColor: "#BB928C",
                pointBackgroundColor: foregroundColor,
                pointBorderColor: "#BB928C",
                pointHoverBackgroundColor: "#BB928C",
                pointHoverBorderColor: foregroundColor,
                pointRadius: 0,
                pointBorderWidth: 0,
                pointHoverRadius: 5,
            ...
            datasets: [
              {
                ...
                data: [456, 479, 324, 569, 702, 600, 456, 479, 324, 569, 702, 600],
                borderWidth: 1
              },
              {
                label: "Expenses",
                borderColor: "#BB928C",
                backgroundColor: "#BB928C",
                data: [364, 504, 605, 400, 345, 320, 364, 504, 605, 400, 345, 320],
                borderWidth: 1
              }
            ]
          }
